      ...
      <form className="space-y-5" onSubmit={handleSubmit}>
        ...
        <div className="flex items-center justify-between gap-4 text-sm">
          <label className="flex items-center gap-2 text-zinc-600 cursor-pointer select-none">
            <input
              type="checkbox"
              className="h-4 w-4 rounded border-[#3d4a2e]/30 accent-[#3d4a2e]"
            />
            <span>Remember me</span>
          </label>
          <button
            type="button"
            className="font-medium text-[#3d4a2e] transition hover:text-[#5a6e44] hover:underline"
          >
            Forgot Password?
          </button>
        </div>
        ...
        <div className="relative my-2">
          ...
          <div className="relative flex justify-center">
            <span className="bg-[#faf7f2] px-3 text-xs text-zinc-400">or continue with</span>
          </div>
        </div>
